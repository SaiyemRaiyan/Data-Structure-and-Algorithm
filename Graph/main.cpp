...
int main()
{
    ...
    cout<<g.FoundEdge('A', 'D')<<endl;     // Print if there is an edge between vertices A and D
    cout<<g.FoundEdge('B', 'D')<<endl;    // Print if there is an edge between vertices B and D
